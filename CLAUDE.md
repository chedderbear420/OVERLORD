...
| 4O | Signal Evaluation Pass | active — PR open |
| 4P | Paper Ledger | next |
...
npm run test:strategy-dsl              # ~261 tests (2 pre-existing CRLF failures on Windows)

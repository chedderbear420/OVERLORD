...
export const APPROVED_PAPER_SETTLEMENT_STATUSES = new Set(["unsettled"]);
 ...
 * - Paper accounting only — one contract unit, unsettled, no live execution.
...
export function buildKalshiPaperLedgerEntry(
  ...
  return {
    ...
    // Paper economics — one contract unit, unsettled observation.
    ...
    paper_fees_cents,
    paper_net_pnl_cents,
    paper_contract_quantity: options.paperContractQuantity,
    ...
    research_summary: {
      entry_recorded: true,
      settlement_complete: paper_settlement_status === "settled",
      pnl_realized: paper_realized_pnl_cents !== null,
    },
